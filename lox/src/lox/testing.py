...
def read_example(soure_or_path: str | Path) -> "Example":
    """
    Retorna um exemplo a partir de uma string ou arquivo contendo o código-fonte 
    Lox.
    """
...
def parse_example(source: str) -> "Example":
    """
    Analisa uma string de código-fonte e retorna um objeto Example.
    """
    expect: list[Result] = []
