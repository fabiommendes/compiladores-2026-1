...
Habilite a funcionalidade "Watch" no repositório para receer notificações sobre atualizações.
...
* Trabalho em casa valendo 10% da nota.
* Desafios e atividades competitivas podem acrescentar pontos extra na
  lista de exercícios.

A menção é calculada de forma usual a partir da média das notas. Alunos que
mostrarem um rendimento de no mínimo 90% no trabalho garantem uma menção mínima
